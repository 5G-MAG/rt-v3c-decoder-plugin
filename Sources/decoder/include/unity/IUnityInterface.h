...
// USAGE:
// ---------
// To retrieve an interface a user can do the following from a plugin, assuming they have the header file for the
// interface:
//
...
//
// UNITY_REGISTER_INTERFACE_GUID should be placed in the header file of any interface definition outside of all
// namespaces. The interface structure and the registration GUID are all that is required to expose the interface to
// other systems.
...
#define UNITY_GET_INTERFACE(INTERFACES, TYPE)                                                                          \
    (TYPE *) INTERFACES->GetInterfaceSplit(UNITY_GET_INTERFACE_GUID(TYPE).m_GUIDHigh,                                  \
